                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" action="process_register.php" method="POST">
                                ...
                                <div class="form-group">
                                    <input type="email" name="emailaddress" class="form-control form-control-user" id="exampleInputEmail"
                                ...
                                <div class="form-group">
                                    <input type="text" name="address" class="form-control form-control-user" id="exmapleInputAddress"
                                        placeholder="Address">
                                </div>
                                <div class="form-group">
                                    <input type="number" name="phonenumber" class="form-control form-control-user" id="exampleInputPNumber"
